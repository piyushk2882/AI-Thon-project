...
const SignupPage = () => {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4 bg-surface relative overflow-hidden">
      ...
      <div className="absolute top-[-15%] left-[-10%] w-[600px] h-[600px] rounded-full bg-secondary/8 blur-[140px] pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] rounded-full bg-primary/8 blur-[120px] pointer-events-none" />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-on-surface-variant mt-2 text-sm">Join thousands of AI-powered travelers.</p>
        </div>
        ...
        <div className="bg-surface-container-lowest rounded-2xl p-8 md:p-10 shadow-[0_32px_64px_rgba(0,0,0,0.06)] border border-outline-variant/10">
          <h2 className="font-headline text-3xl font-extrabold text-on-surface mb-1">Create account</h2>
          <p className="text-on-surface-variant text-sm mb-8">Start planning smarter, today.</p>
          ...
          {success && (
            <div className="mb-6 flex items-start gap-3 bg-primary/10 border border-primary/20 text-primary p-4 rounded-xl text-sm font-medium">
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 material-symbols-outlined text-outline group-focus-within:text-primary transition-colors text-xl">lock_reset</span>
                <input
                  id="signup-confirm"
                  type="password"
                  autoComplete="new-password"
